...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'image_ang': $value = ($this->targetDirs[3].'/../filrouge/src/assets/img'); break;
            ...
            case 'vich_uploader.mappings': $value = [
                'User' => [
                    ...
                    'upload_destination' => ($this->targetDirs[3].'/../filrouge/src/assets/img'),
