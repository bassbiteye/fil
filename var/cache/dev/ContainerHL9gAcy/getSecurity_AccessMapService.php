...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/users'), [0 => 'ROLE_USERS'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/caissier'), [0 => 'ROLE_CAISSIER'], NULL);
