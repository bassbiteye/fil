...
// Returns the private 'App\Repository\ComEtatRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ComEtatRepository.php';

return $this->privates['App\\Repository\\ComEtatRepository'] = new \App\Repository\ComEtatRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
