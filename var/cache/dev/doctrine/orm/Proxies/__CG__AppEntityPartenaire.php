...
class Partenaire extends \App\Entity\Partenaire implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function setMail(string $mail): \App\Entity\Partenaire
    {
     ...
     * {@inheritDoc}
     */
    public function setFix(int $fix): \App\Entity\Partenaire
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFix', [$fix]);

        return parent::setFix($fix);
    }
