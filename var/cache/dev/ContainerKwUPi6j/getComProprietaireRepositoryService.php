...
// Returns the private 'App\Repository\ComProprietaireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ComProprietaireRepository.php';

return $this->privates['App\\Repository\\ComProprietaireRepository'] = new \App\Repository\ComProprietaireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
