...
// Returns the private 'vich_uploader.listener.remove.User' shared service.
...
return $this->privates['vich_uploader.listener.remove.User'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('User', ($this->privates['vich_uploader.adapter.orm'] ?? ($this->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($this->privates['vich_uploader.metadata_reader'] ?? $this->load('getVichUploader_MetadataReaderService.php')), ($this->services['vich_uploader.upload_handler'] ?? $this->load('getVichUploader_UploadHandlerService.php')));
