...
$instance->addLoader(($this->privates['doctrine.orm.default_entity_manager.validator_loader'] ?? $this->load('getDoctrine_Orm_DefaultEntityManager_ValidatorLoaderService.php')));
