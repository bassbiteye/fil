...
$instance->addEventSubscriber(($this->privates['vich_uploader.listener.clean.User'] ?? $this->load('getVichUploader_Listener_Clean_UserService.php')));
$instance->addEventSubscriber(($this->privates['vich_uploader.listener.remove.User'] ?? $this->load('getVichUploader_Listener_Remove_UserService.php')));
$instance->addEventSubscriber(($this->privates['vich_uploader.listener.upload.User'] ?? $this->load('getVichUploader_Listener_Upload_UserService.php')));
