...
return $this->services['vich_uploader.upload_handler'] = new \Vich\UploaderBundle\Handler\UploadHandler(($this->privates['vich_uploader.property_mapping_factory'] ?? $this->load('getVichUploader_PropertyMappingFactoryService.php')), ($this->privates['vich_uploader.storage.file_system'] ?? $this->load('getVichUploader_Storage_FileSystemService.php')), ($this->privates['vich_uploader.file_injector'] ?? $this->load('getVichUploader_FileInjectorService.php')), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()));
