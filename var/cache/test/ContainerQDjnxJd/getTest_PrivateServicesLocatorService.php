...
return $this->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    'App\\DataFixtures\\SuperAdminFixture' => ['privates', 'App\\DataFixtures\\SuperAdminFixture', 'getSuperAdminFixtureService.php', true],
    ...
    'Vich\\UploaderBundle\\Mapping\\PropertyMappingFactory' => ['privates', 'vich_uploader.property_mapping_factory', 'getVichUploader_PropertyMappingFactoryService.php', true],
    'Vich\\UploaderBundle\\Storage\\FileSystemStorage' => ['privates', 'vich_uploader.storage.file_system', 'getVichUploader_Storage_FileSystemService.php', true],
    'Vich\\UploaderBundle\\Storage\\StorageInterface' => ['privates', 'vich_uploader.storage.file_system', 'getVichUploader_Storage_FileSystemService.php', true],
    'Vich\\UploaderBundle\\Templating\\Helper\\UploaderHelper' => ['services', 'vich_uploader.templating.helper.uploader_helper', 'getVichUploader_Templating_Helper_UploaderHelperService.php', true],
    ...
    'argument_resolver.controller_locator' => ['privates', '.service_locator.x5dC8LG', 'get_ServiceLocator_X5dC8LGService.php', true],
    ...
    'doctrine.orm.default_entity_manager.validator_loader' => ['privates', 'doctrine.orm.default_entity_manager.validator_loader', 'getDoctrine_Orm_DefaultEntityManager_ValidatorLoaderService.php', true],
    ...
    'vich_uploader.adapter.orm' => ['privates', 'vich_uploader.adapter.orm', 'getVichUploader_Adapter_OrmService.php', true],
    ...
    'vich_uploader.listener.clean.User' => ['privates', 'vich_uploader.listener.clean.User', 'getVichUploader_Listener_Clean_UserService.php', true],
    'vich_uploader.listener.remove.User' => ['privates', 'vich_uploader.listener.remove.User', 'getVichUploader_Listener_Remove_UserService.php', true],
    'vich_uploader.listener.upload.User' => ['privates', 'vich_uploader.listener.upload.User', 'getVichUploader_Listener_Upload_UserService.php', true],
    'vich_uploader.metadata.cache' => ['privates', 'vich_uploader.metadata.cache.file_cache', 'getVichUploader_Metadata_Cache_FileCacheService.php', true],
    'vich_uploader.metadata.cache.file_cache' => ['privates', 'vich_uploader.metadata.cache.file_cache', 'getVichUploader_Metadata_Cache_FileCacheService.php', true],
    'vich_uploader.metadata.file_locator' => ['privates', 'vich_uploader.metadata.file_locator', 'getVichUploader_Metadata_FileLocatorService.php', true],
    'vich_uploader.metadata_driver' => ['privates', 'vich_uploader.metadata_driver.chain', 'getVichUploader_MetadataDriver_ChainService.php', true],
    'vich_uploader.metadata_driver.annotation' => ['privates', 'vich_uploader.metadata_driver.annotation', 'getVichUploader_MetadataDriver_AnnotationService.php', true],
    'vich_uploader.metadata_driver.chain' => ['privates', 'vich_uploader.metadata_driver.chain', 'getVichUploader_MetadataDriver_ChainService.php', true],
    'vich_uploader.metadata_driver.xml' => ['privates', 'vich_uploader.metadata_driver.xml', 'getVichUploader_MetadataDriver_XmlService.php', true],
    'vich_uploader.metadata_driver.yaml' => ['privates', 'vich_uploader.metadata_driver.yaml', 'getVichUploader_MetadataDriver_YamlService.php', true],
    'vich_uploader.metadata_factory' => ['privates', 'vich_uploader.metadata_factory', 'getVichUploader_MetadataFactoryService.php', true],
    'vich_uploader.metadata_reader' => ['privates', 'vich_uploader.metadata_reader', 'getVichUploader_MetadataReaderService.php', true],
    'vich_uploader.property_mapping_factory' => ['privates', 'vich_uploader.property_mapping_factory', 'getVichUploader_PropertyMappingFactoryService.php', true],
    'vich_uploader.storage' => ['privates', 'vich_uploader.storage.file_system', 'getVichUploader_Storage_FileSystemService.php', true],
    'vich_uploader.storage.file_system' => ['privates', 'vich_uploader.storage.file_system', 'getVichUploader_Storage_FileSystemService.php', true],
], [
    'App\\DataFixtures\\AppFixtures' => '?',
    'App\\DataFixtures\\SuperAdminFixture' => '?',
    'App\\Form\\CompteType' => '?',
